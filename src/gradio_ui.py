    ...
    with gr.Blocks(title="Pygmalion", analytics_enabled=False) as interface:
        ...
        with gr.Tab("Talk with discord"):
            ...
            async def re(ctx):
                ...
                nonlocal discord_message , discord_history_for_model , discord_history_for_gradio , discord_chat
                discord_message, discord_history_for_model, discord_history_for_gradio, discord_chat = _regenerate(
                    discord_history_for_model, discord_history_for_gradio, discord_generation_settings, discord_char_name, discord__user_name, discord_char_persona, discord_char_greeting, discord_world_scenario, discord_example_dialogue)

                bot_response = "regeneration : " + str(discord_chat[-1])
            ...
            async def un(ctx):
                ...
                nonlocal discord_history_for_model, discord_history_for_gradio, discord_chat
                
                discord_history_for_model, discord_history_for_gradio, discord_chat = _undo_last_exchange(discord_history_for_model, discord_history_for_gradio)
